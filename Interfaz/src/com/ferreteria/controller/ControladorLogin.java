 ...
 * @author TÚ (Frontend)
 * 
 * Este controlador conecta la vista (LoginFrame) con la lógica de negocio (AutenticacionService).
...
public class ControladorLogin {
    ...
    public void intentarLogin() {
        ...
        if (usuario != null) {
            ...
            // TODO: Aquí abrirías la siguiente ventana (MenuPrincipal o Dashboard)
            // Por ejemplo:
